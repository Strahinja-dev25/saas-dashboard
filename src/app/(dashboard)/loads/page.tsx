                                ...
                                <TableCell className="text-center">
                                    <div className="flex items-center justify-end gap-2">
                                        ...
                                        {load.status === "ASSIGNED" && (
                                            load.truck?.driver ? (
                                                <SubmitAction
                                                    action={updateLoadStatus.bind(null, load.id, "IN_TRANSIT")}
                                                    successMessage="Tura je uspešno započeta!"
                                                    variant="outline"
                                                    size="sm"
                                                    className="h-8 px-2 text-xs font-semibold bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 shadow-sm"
                                                >
                                        ...
                                        {load.status === "IN_TRANSIT" && (
                                            <SubmitAction
                                                action={updateLoadStatus.bind(null, load.id, "DELIVERED")}
                                                successMessage="✅ Tura je uspešno završena!"
                                                variant="outline"
                                                size="sm"
                                                className="h-8 px-2 text-xs font-semibold bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100 shadow-sm"
                                            >
                                        ...
                                        {(load.status === "PENDING" || load.status === "ASSIGNED" || load.status === "IN_TRANSIT") && (
                                            <SubmitAction
                                                action={updateLoadStatus.bind(null, load.id, "CANCELLED")}
                                                successMessage="Tura je otkazana."
                                                variant="outline"
                                                size="sm"
                                                className="h-8 px-2 text-xs font-semibold bg-red-50 text-red-700 border-red-200 hover:bg-red-100 shadow-sm"
                                            >
                                        ...
                                        <SubmitAction
                                            action={deleteLoad.bind(null, load.id)}
                                            successMessage="Tura je izbrisana iz baze."
                                            variant="ghost"
                                            size="icon"
